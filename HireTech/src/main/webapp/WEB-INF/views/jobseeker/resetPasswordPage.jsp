...
<body>
	...
	<div class="header">
		...
		<div class="nav-buttons">
			<a href="/jobseeker/profile" class="back-button">Back to Profile</a>
			<a href="/jobseeker/openIndexPage" class="back-button">Back to
				Dashboard</a>
		</div>
	</div>
	...
	<div class="content">
		...
		<form action="/jobseeker/updatePassword" method="POST"
