...
<title>View Rejected Applicants - HireTech</title>
<link href="../css/viewrejected.css" rel="stylesheet" type="text/css" />
...
<body>
	...
	<div class="container">
		<h2 class="text-center mb-4">
			<i class="fa fa-spinner fa-spin"></i> Rejected Applicants
		</h2>
		<div class="card-container">
			...
			<div class="alert alert-info" role="alert">
				<h3>No rejected applicants available.</h3>
			</div>
			<%
			} else {
					...
					<div class="row mt-3 w-100">
						<div class="col-sm-6">
							<a
								...
								<button class="reject-button" onclick="confirmApproval(event)">Approve
									Applicant</button>
							</a>
						</div>
