...
<title>View Pending Applicants - HireTech</title>
<link href="../css/viewpending.css" rel="stylesheet" type="text/css" />
...
<body>
	...
	<div class="container">
		<h2 class="text-center mb-4">
			<i class="fa fa-spinner fa-spin"></i> Pending Applicants
		</h2>
		<div class="row">
			<%
			...
			<div class="alert alert-info" role="alert">
				<h3>No pending applicants available.</h3>
			</div>
			<%
			} else {
			...
			%>
			<div class="col-md-6 ">
				<div class="applicant-card" style="text-align: left;">
					...
					<div class="card-buttons">
						<div class="row mt-3 w-100">
							<div class="col-sm-6">
								<a
									href="/employer/approveApplicant/<%=applicant.getApplicationId()%>/<%=applicant.getApplicationStatus()%>/1">
									<button class="approve-button" onclick="confirmApproval(event)">Approve
										Applicant</button>
								</a>
							</div>
							<div class="col-sm-6">
