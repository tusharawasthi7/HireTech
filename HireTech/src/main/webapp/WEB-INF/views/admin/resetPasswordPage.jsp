...
<body>
	<div class="header">
		...
		<div class="nav-buttons">
			<a href="/admin/profile" class="back-button">Back to Profile</a> <a
				href="/admin/backToDashboard" class="back-button">Back to Dashboard</a>
		</div>
	</div>
	...
	<div class="content">
		...
		<form action="/admin/updatePassword" method="POST" onsubmit="return validateJobSeekerForm()">
			...
			<label for="newPassword">New Password:</label> <input type="password"
				id="newPassword" name="newPassword" oninput="validateNewPassword()" required> <label
				for="confirmPassword">Confirm Password:</label> <input
				type="password" id="confirmPassword" name="confirmPassword" oninput="validateConfirmPassword()" required>
