...
<head>
<meta charset="UTF-8">
<title>Pending Employer List</title>
...
<body>
	...
	<div class="container">
		<h1>Pending Employer List</h1>
		<!-- Header for the table -->
		<%
		List<Map<String, Object>> pendingEmployers = (List<Map<String, Object>>) request.getAttribute("pendingEmployers");
		if (pendingEmployers == null || pendingEmployers.isEmpty()) {
		%>
		<p>No pending employer requests available.</p>
		<%
		} else {
		%>
		<table>
			...
			<%
			int sNo = 0;
			for (Map<String, Object> info : pendingEmployers) {
