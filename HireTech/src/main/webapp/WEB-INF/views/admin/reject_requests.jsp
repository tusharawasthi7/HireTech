...
<head>
<meta charset="UTF-8">
<title>Rejected Employer List</title>
...
<body>
	...
	<div class="container">
		<h1>Rejected Employer List</h1>
		<!-- Header for the table -->
		<%
		List<Map<String, Object>> rejectEmployers = (List<Map<String, Object>>) request.getAttribute("rejectEmployers");
		if (rejectEmployers == null || rejectEmployers.isEmpty()) {
		%>
		<p>No rejected employer requests available.</p>
		<%
		} else {
		%>
		<table>
			...
			<%
			int sNo = 0;
			for (Map<String, Object> info : rejectEmployers) {
